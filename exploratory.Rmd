...
# GDP (Constant/Current??), "% pop urban", Gov Final Expenditure

indicators <- c("SP.URB.TOTL.IN.ZS", "NY.GDP.MKTP.KN", "NE.CON.GOVT.CD",
                "SP.POP.0014.TO.ZS",  "SP.POP.65UP.TO.ZS" )

a <- WDI(country = countries, indicator = indicators,
         start = 1981, end = 2015)
